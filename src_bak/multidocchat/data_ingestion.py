...
class DocumentIngestor:
    ...
    def __init__(self,tem_dir:str="data/multi_doc_chat",faiss_dir:str="faiss_index",session_id:str |None=None):
        try:
            ...
            self.log.error("Failed to initialize DocumentIgester",error=str(e))
            raise DocumentPortalException("initifalization error in DocumentIgestor")
